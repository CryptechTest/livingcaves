...
minetest.register_craft({
    ...
    recipe = { { "livingcaves:stalagmitelarge", "", "livingcaves:stalagmitelarge" }, { "", "default:stick", "" } }
})
...
stairs.register_stair_and_slab("livingcaves_rootdirt_woven", "livingcaves:root_wood", {
    choppy = 2,
    oddly_breakable_by_hand = 1,
    flammable = 3
}, { "livingcaves_rootdirt_woven.png" }, S("Root Stair"), S("Root Slab"), default.node_sound_wood_defaults())

stairs.register_stair_and_slab("livingcaves_root_dirt", "livingcaves:rootdirt", {
        choppy = 2,
        oddly_breakable_by_hand = 1,
        flammable = 3
    }, { "livingcaves_rootdirt.png", "livingcaves_rootdirt.png", "livingcaves_rootdirt.png" }, S("Root Dirt Stair"),
    S("Root Dirt Slab"), default.node_sound_wood_defaults())

doors.register_fencegate("livingcaves:gate_root_wood", {
...
default.register_fence("livingcaves:fence_root_wood", {
...
default.register_fence_rail("livingcaves:fence_rail_root_wood", {
...
doors.register("door_livingcaves_root", {
    tiles = { {
        name = "livingcaves_door_rootdirt.png",
    ...
    recipe = { { "livingcaves:root_wood", "livingcaves:root_wood", "livingcaves:root_wood" },
...
minetest.register_craft({
    output = "livingcaves:root_lamp",
    recipe = { { "livingcaves:rootcave_hangingroot2", "livingcaves:glowshroom_top", "livingcaves:glowshroom" },
        { "",                                  "",                           "" } }
})
...
stairs.register_stair_and_slab("livingcaves_icecbricks", "livingcaves:icebrick", {
    cracky = 1,
    oddly_breakable_by_hand = 0,
    flammable = 0
}, { "livingcaves_icecbricks.png" }, S("Ice Brick Stair"), S("Ice Brick Slab"), default.node_sound_ice_defaults())
...
minetest.register_craft({
    ...
    type = "shapeless",
    recipe = { "livingcaves:icecave_ice", "livingcaves:icecave_ice" }
})

minetest.register_craft({
    output = "livingcaves:icebrick",
    type = "shapeless",
    recipe = { "livingcaves:icecave_ice2", "livingcaves:icecave_ice2" }
})

minetest.register_craft({
    output = "livingcaves:icebrick_wall",
    type = "shapeless",
    recipe = { "livingcaves:icebrick" }
})

default.register_fence("livingcaves:fence_ice", {
...
default.register_fence_rail("livingcaves:fence_rail_ice", {
...
doors.register("door_livingcaves_ice", {
    ...
    recipe = { { "livingcaves:icebrick", "livingcaves:icebrick",          "livingcaves:icebrick" },
...
minetest.register_craft({
    ...
    recipe = { { "livingcaves:icestalagmite", "livingcaves:icestalagmite", "livingcaves:icestalagmite" },
        { "livingcaves:icestalagmite", "livingcaves:icestalagmite", "livingcaves:icestalagmite" }, { "", "", "" } }
})
...
stairs.register_stair_and_slab("livingcaves_dripstonecave_bricks", "livingcaves:dripstonebrick", {
        cracky = 1,
        oddly_breakable_by_hand = 0,
        flammable = 0
    }, { "livingcaves_dripstonecave_bricks.png" }, S("Dripstone Brick Stair"), S("Dripstone Brick Slab"),
...
minetest.register_craft({
    ...
    type = "shapeless",
    recipe = { "livingcaves:dripstonecave_bottom", "livingcaves:dripstonecave_bottom" }
})

minetest.register_craft({
    output = "livingcaves:dripstonebrick",
    type = "shapeless",
    recipe = { "livingcaves:dripstonecave_bottom2", "livingcaves:dripstonecave_bottom2" }
})

minetest.register_craft({
    output = "livingcaves:dripstonebrick_wall",
    type = "shapeless",
    recipe = { "livingcaves:dripstonebrick" }
})

doors.register("door_livingcaves_dripstone", {
    tiles = { {
        name = "livingcaves_door_dripstone.png",
        backface_culling = true
    } },
    ...
    sound_open = "doors_steel_door_open",
    sound_close = "doors_steel_door_close",
    recipe = { { "livingcaves:dripstonebrick", "livingcaves:dripstonebrick", "livingcaves:dripstonebrick" },
...
minetest.register_craft({
    ...
    recipe = { { "livingcaves:stalagmite", "livingcaves:stalagmite", "livingcaves:stalagmite" },
        { "livingcaves:stalagmite", "livingcaves:stalagmite", "livingcaves:stalagmite" }, { "", "", "" } }
})
...
stairs.register_stair_and_slab("livingcaves_mushcave_mossybricks", "livingcaves:mushcave_mossybricks", {
        cracky = 1,
        oddly_breakable_by_hand = 0,
        flammable = 0
    }, { "livingcaves_mushcave_mossybricks.png" }, S("Mossy Stone Brick Stair"), S("Mossy Stone Brick Slab"),
    default.node_sound_stone_defaults())
...
minetest.register_craft({
    ...
    type = "shapeless",
    recipe = { "group:mushy_rock", "group:mushy_rock" }
})

minetest.register_craft({
    output = "livingcaves:mossybrick_wall",
    type = "shapeless",
    recipe = { "livingcaves:mushcave_mossybricks" }
})
...
minetest.register_craft({
    ...
    type = "shapeless",
    recipe = { "livingcaves:lichen", "group:glow_shroom", "livingcaves:mushroom_edible", "livingcaves:bucket_cavewater" }
})
...
minetest.register_craft({
    ...
    type = "shapeless",
    recipe = { "livingcaves:spiderweb9", "livingcaves:spiderweb9" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb8", "livingcaves:spiderweb8" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb7", "livingcaves:spiderweb7" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb6", "livingcaves:spiderweb6" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb5", "livingcaves:spiderweb5" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb4", "livingcaves:spiderweb4" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb3", "livingcaves:spiderweb3" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb2", "livingcaves:spiderweb2" }
})

minetest.register_craft({
    output = "farming:string",
    type = "shapeless",
    recipe = { "livingcaves:spiderweb", "livingcaves:spiderweb" }
})
