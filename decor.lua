...
minetest.register_decoration({
    ...
    rotation = "random",
    biomes = { "caves_mossy", "caves_mossy2", "coniferous_forest_under", "rainforest", "rainforest_ocean", "rainforest_under", "taiga_ocean", "grassland_ocean", "savanna_under", "deciduous_forest_under" },
})
